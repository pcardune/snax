...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c1 = peg$otherExpectation("block");
  ...
  const peg$c3 = peg$otherExpectation("statement");
  const peg$c4 = "let";
  const peg$c5 = peg$literalExpectation("let", false);
  const peg$c6 = ":";
  ...
  const peg$c12 = function(name: any, type: any, expr: any): any {
      return new AST.LetStatement(name, type ? type[2] : null, expr);
    };
  const peg$c13 = function(funcDecl: any): any { return funcDecl; };
  const peg$c14 = "return";
  const peg$c15 = peg$literalExpectation("return", false);
  const peg$c16 = function(expr: any): any {
  ...
  const peg$c33 = peg$otherExpectation("parameter");
  const peg$c34 = function(name: any, type: any): any {
      return new AST.Parameter(name, type);
    };
  const peg$c35 = peg$otherExpectation("typeExpr");
  const peg$c36 = function(typeRef: any): any { return new AST.TypeExpr(typeRef); };
  const peg$c37 = peg$otherExpectation("typeRef");
  const peg$c38 = function(name: any): any { return new AST.TypeRef(name); };
  const peg$c39 = peg$otherExpectation("expr");
  const peg$c40 = peg$otherExpectation("assignment");
  const peg$c41 = function(left: any, right: any): any {
      return new AST.Expression(AST.BinaryOp.ASSIGN, left, right);
    };
  const peg$c42 = peg$otherExpectation("bool or");
  const peg$c43 = "||";
  const peg$c44 = peg$literalExpectation("||", false);
  const peg$c45 = function(left: any, right: any): any {
      return new AST.Expression(AST.BinaryOp.LOGICAL_OR, left, right);
    };
  const peg$c46 = peg$otherExpectation("bool op");
  const peg$c47 = "&&";
  ...
  const peg$c50 = peg$otherExpectation("additive");
  const peg$c51 = "+";
  const peg$c52 = peg$literalExpectation("+", false);
  const peg$c53 = "-";
  const peg$c54 = peg$literalExpectation("-", false);
  const peg$c55 = function(left: any, right: any): any {
  ...
  const peg$c56 = peg$otherExpectation("term");
  const peg$c57 = "*";
  const peg$c58 = peg$literalExpectation("*", false);
  const peg$c59 = "/";
  const peg$c60 = peg$literalExpectation("/", false);
  const peg$c61 = function(left: any, right: any): any {
      return right.reduce((result: AST.ASTNode, element: any[]) => {
        let op = element[1] === "*" ? AST.BinaryOp.MUL : AST.BinaryOp.DIV;
        return new AST.Expression(op, result, element[3]);
      }, left);
    };
  const peg$c62 = peg$otherExpectation("calling");
  const peg$c63 = function(funcExpr: any, argList: any): any {
      return new AST.Expression(AST.BinaryOp.CALL, funcExpr, new AST.ArgList(argList || []));
    };
  const peg$c64 = peg$otherExpectation("indexing");
  const peg$c65 = "[";
  const peg$c66 = peg$literalExpectation("[", false);
  const peg$c67 = "]";
  const peg$c68 = peg$literalExpectation("]", false);
  const peg$c69 = function(element: any, index: any): any {
      return new AST.Expression(AST.BinaryOp.ARRAY_INDEX, element, index);
    };
  const peg$c70 = peg$otherExpectation("factor");
  const peg$c71 = function(inner: any): any { return inner; };
  const peg$c72 = peg$otherExpectation("array");
  const peg$c73 = function(items: any): any { return new AST.ArrayLiteral(items || []); };
  const peg$c74 = peg$otherExpectation("exprList");
  const peg$c75 = function(head: any, tail: any): any { return [head, ...tail.map((t:any[])=>t[3])]; };
  const peg$c76 = peg$otherExpectation("number");
  const peg$c77 = peg$otherExpectation("integer");
  const peg$c78 = /^[0-9]/;
  const peg$c79 = peg$classExpectation([["0", "9"]], false, false);
  const peg$c80 = function(digits: any): any { return new AST.NumberLiteral(parseInt(digits.join(''))); };
  const peg$c81 = peg$otherExpectation("float");
  const peg$c82 = ".";
  const peg$c83 = peg$literalExpectation(".", false);
  const peg$c84 = function(leftDigits: any, rightDigits: any): any {
  ...
  const peg$c87 = function(): any { return new AST.BooleanLiteral(true); };
  const peg$c88 = "false";
  const peg$c89 = peg$literalExpectation("false", false);
  const peg$c90 = function(): any { return new AST.BooleanLiteral(false); };
  const peg$c91 = peg$otherExpectation("symbol");
  const peg$c92 = function(name: any): any { return new AST.SymbolRef(name); };
  const peg$c93 = peg$otherExpectation("identifier");
  const peg$c94 = /^[a-z_]/i;
  const peg$c95 = peg$classExpectation([["a", "z"], "_"], false, true);
  const peg$c96 = /^[a-z0-9_]/i;
  const peg$c97 = peg$classExpectation([["a", "z"], ["0", "9"], "_"], false, true);
  const peg$c98 = function(prefix: any, suffix: any): any { return prefix+suffix.join(''); };
  const peg$c99 = /^[ \n\t\r]/;
