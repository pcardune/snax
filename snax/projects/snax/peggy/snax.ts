...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c116 = peg$otherExpectation("cast");
  const peg$c117 = "as";
  const peg$c118 = peg$literalExpectation("as", false);
  const peg$c119 = "!";
  const peg$c120 = peg$literalExpectation("!", false);
  const peg$c121 = function(expr: any, force: any, typeExpr: any): any {
  ...
  const peg$c122 = peg$otherExpectation("calling");
  const peg$c123 = function(funcExpr: any, argList: any): any {
      return spec.makeCallExpr(funcExpr, spec.makeArgList(argList || []));
    };
  const peg$c124 = peg$otherExpectation("indexing");
  const peg$c125 = "[";
  const peg$c126 = peg$literalExpectation("[", false);
  const peg$c127 = "]";
  const peg$c128 = peg$literalExpectation("]", false);
  const peg$c129 = function(element: any, index: any): any {
      return spec.makeBinaryExpr(AST.BinOp.ARRAY_INDEX, element, index);
    };
  const peg$c130 = peg$otherExpectation("deref");
  const peg$c131 = "@";
  const peg$c132 = peg$literalExpectation("@", false);
  const peg$c133 = function(expr: any): any {
      return spec.makeUnaryExpr(AST.UnaryOp.ADDR_OF, expr);
    };
  const peg$c134 = peg$otherExpectation("memberAccess");
  const peg$c135 = ".";
  const peg$c136 = peg$literalExpectation(".", false);
  const peg$c137 = function(rest: any, val: any): any {
      return leftAssoc(
        rest,
        val,
  ...
  const peg$c138 = peg$otherExpectation("factor");
  const peg$c139 = function(inner: any): any { return inner; };
  const peg$c140 = peg$otherExpectation("struct literal");
  const peg$c141 = "::";
  const peg$c142 = peg$literalExpectation("::", false);
  const peg$c143 = function(structName: any, values: any): any {
      return spec.makeStructLiteral(structName, values || []);
    };
  const peg$c144 = function(head: any, tail: any): any {
      return [head, ...tail.map((t:any[]) => t[3])];
    };
  const peg$c145 = function(propName: any, expr: any): any {
      return spec.makeStructLiteralProp(propName, expr);
    };
  const peg$c146 = peg$otherExpectation("string");
  const peg$c147 = "\"";
  const peg$c148 = peg$literalExpectation("\"", false);
  const peg$c149 = "\\";
  const peg$c150 = peg$literalExpectation("\\", false);
  const peg$c151 = peg$anyExpectation();
  const peg$c152 = /^[^"]/;
  const peg$c153 = peg$classExpectation(["\""], true, false);
  const peg$c154 = function(content: any): any {
      const inner = content.map((c:any) => typeof c === "string" ? c : c.join('')).join('');
      return spec.makeStringLiteral(JSON.parse('"'+inner+'"'));
    };
  const peg$c155 = peg$otherExpectation("char");
  const peg$c156 = "'";
  const peg$c157 = peg$literalExpectation("'", false);
  const peg$c158 = function(content: any): any {
  ...
  const peg$c159 = peg$otherExpectation("array");
  const peg$c160 = function(items: any): any { return spec.makeArrayLiteral(items || []); };
  const peg$c161 = peg$otherExpectation("exprList");
  const peg$c162 = function(head: any, tail: any): any { return [head, ...tail.map((t:any[])=>t[3])]; };
  const peg$c163 = peg$otherExpectation("number");
  const peg$c164 = peg$otherExpectation("integer");
  const peg$c165 = "_";
  const peg$c166 = peg$literalExpectation("_", false);
  const peg$c167 = "i";
  const peg$c168 = peg$literalExpectation("i", false);
  const peg$c169 = "u";
  const peg$c170 = peg$literalExpectation("u", false);
  const peg$c171 = "8";
  const peg$c172 = peg$literalExpectation("8", false);
  const peg$c173 = "16";
  const peg$c174 = peg$literalExpectation("16", false);
  const peg$c175 = "32";
  const peg$c176 = peg$literalExpectation("32", false);
  const peg$c177 = "64";
  const peg$c178 = peg$literalExpectation("64", false);
  const peg$c179 = function(digits: any, type: any): any {
  ...
  const peg$c180 = peg$otherExpectation("digits");
  const peg$c181 = /^[0-9]/;
  const peg$c182 = peg$classExpectation([["0", "9"]], false, false);
  const peg$c183 = function(digits: any): any { return parseInt(digits.join('')); };
  const peg$c184 = peg$otherExpectation("float");
  const peg$c185 = function(leftDigits: any, rightDigits: any): any {
      return spec.makeNumberLiteral(
  ...
  const peg$c186 = "true";
  const peg$c187 = peg$literalExpectation("true", false);
  const peg$c188 = function(): any { return spec.makeBooleanLiteral(true); };
  const peg$c189 = "false";
  const peg$c190 = peg$literalExpectation("false", false);
  const peg$c191 = function(): any { return spec.makeBooleanLiteral(false); };
  const peg$c192 = peg$otherExpectation("symbol");
  const peg$c193 = function(name: any): any { return spec.makeSymbolRef(name); };
  const peg$c194 = peg$otherExpectation("identifier");
  const peg$c195 = /^[a-z_]/i;
  const peg$c196 = peg$classExpectation([["a", "z"], "_"], false, true);
  const peg$c197 = /^[a-z0-9_]/i;
  const peg$c198 = peg$classExpectation([["a", "z"], ["0", "9"], "_"], false, true);
  const peg$c199 = function(prefix: any, suffix: any): any { return prefix+suffix.join(''); };
  const peg$c200 = /^[ \n\t\r]/;
