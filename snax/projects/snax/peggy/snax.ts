...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c72 = function (val: any, rest: any): any {
    return rightAssoc(val, rest, ({ left, right }) =>
      spec.makeBinaryExpr(AST.BinaryOp.ASSIGN, left, right)
    );
  };
  ...
  const peg$c76 = function (rest: any, val: any): any {
    return leftAssoc(rest, val, ({ left, right }) =>
      spec.makeBinaryExpr(AST.BinaryOp.LOGICAL_OR, left, right)
    );
  };
  ...
  const peg$c80 = function (rest: any, val: any): any {
    return leftAssoc(rest, val, ({ left, right }) =>
      spec.makeBinaryExpr(AST.BinaryOp.LOGICAL_AND, left, right)
    );
  };
  ...
  const peg$c126 = function (inner: any): any {
    return inner;
  };
  ...
  const peg$c141 = function (items: any): any {
    return spec.makeArrayLiteral(items || []);
  };
  const peg$c142 = peg$otherExpectation('exprList');
  const peg$c143 = function (head: any, tail: any): any {
  ...
  const peg$c178 = function (prefix: any, suffix: any): any {
