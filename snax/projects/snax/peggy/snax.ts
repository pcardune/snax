...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c138 = function(expr: any): any {
      return spec.makeUnaryExpr(AST.UnaryOp.LOGICAL_NOT, expr);
    };
  const peg$c139 = peg$otherExpectation("cast");
  const peg$c140 = "as";
  const peg$c141 = peg$literalExpectation("as", false);
  const peg$c142 = function(expr: any, force: any, typeExpr: any): any {
  ...
  const peg$c143 = peg$otherExpectation("calling");
  const peg$c144 = "$";
  const peg$c145 = peg$literalExpectation("$", false);
  const peg$c146 = function(id: any, argList: any): any {
      return spec.makeCompilerCallExpr(id, spec.makeArgList(argList || []));
    };
  const peg$c147 = function(funcExpr: any, argList: any): any {
      return spec.makeCallExpr(funcExpr, spec.makeArgList(argList || []));
    };
  const peg$c148 = peg$otherExpectation("indexing");
  const peg$c149 = function(element: any, rest: any): any {
  ...
  const peg$c154 = peg$otherExpectation("memberAccess");
  const peg$c155 = ".";
  const peg$c156 = peg$literalExpectation(".", false);
  const peg$c157 = function(rest: any, val: any): any {
      return leftAssoc(
        rest,
        val,
  ...
  const peg$c158 = peg$otherExpectation("factor");
  const peg$c159 = function(inner: any): any { return inner; };
  const peg$c160 = peg$otherExpectation("struct literal");
  const peg$c161 = "::";
  ...
  const peg$c164 = function(structName: any, values: any): any {
      values = values ?? [];
  ...
  const peg$c166 = function(propName: any, expr: any): any {
      return spec.makeStructLiteralProp(propName, expr);
    };
  const peg$c167 = peg$otherExpectation("string");
  const peg$c168 = function(value: any): any {
      return spec.makeStringLiteral(value);
    };
  const peg$c169 = peg$otherExpectation("quotedString");
  const peg$c170 = "\"";
  const peg$c171 = peg$literalExpectation("\"", false);
  const peg$c172 = "\\";
  const peg$c173 = peg$literalExpectation("\\", false);
  const peg$c174 = peg$anyExpectation();
  const peg$c175 = /^[^"]/;
  const peg$c176 = peg$classExpectation(["\""], true, false);
  const peg$c177 = function(content: any): any {
      const inner = content.map((c:any) => typeof c === "string" ? c : c.join('')).join('');
      return JSON.parse('"'+inner+'"');
    };
  const peg$c178 = peg$otherExpectation("char");
  const peg$c179 = "'";
  const peg$c180 = peg$literalExpectation("'", false);
  const peg$c181 = function(content: any): any {
  ...
  const peg$c182 = peg$otherExpectation("array");
  const peg$c183 = function(value: any, size: any): any {
      return spec.makeArrayLiteralWith({elements:[value], size});
    };
  const peg$c184 = function(items: any): any {
      return spec.makeArrayLiteralWith({elements:items || []});
    };
  const peg$c185 = peg$otherExpectation("exprList");
  const peg$c186 = function(head: any, tail: any): any { return [head, ...tail.map((t:any[])=>t[3])]; };
  const peg$c187 = peg$otherExpectation("number");
  const peg$c188 = peg$otherExpectation("integer");
  const peg$c189 = "_";
  const peg$c190 = peg$literalExpectation("_", false);
  const peg$c191 = "i";
  const peg$c192 = peg$literalExpectation("i", false);
  const peg$c193 = "u";
  const peg$c194 = peg$literalExpectation("u", false);
  const peg$c195 = "8";
  const peg$c196 = peg$literalExpectation("8", false);
  const peg$c197 = "16";
  const peg$c198 = peg$literalExpectation("16", false);
  const peg$c199 = "32";
  const peg$c200 = peg$literalExpectation("32", false);
  const peg$c201 = "64";
  const peg$c202 = peg$literalExpectation("64", false);
  const peg$c203 = function(digits: any, type: any): any {
  ...
  const peg$c204 = peg$otherExpectation("digits");
  const peg$c205 = /^[0-9]/;
  const peg$c206 = peg$classExpectation([["0", "9"]], false, false);
  const peg$c207 = function(digits: any): any { return parseInt(digits.join('')); };
  const peg$c208 = peg$otherExpectation("float");
  const peg$c209 = function(leftDigits: any, rightDigits: any): any {
      return spec.makeNumberLiteral(
  ...
  const peg$c210 = "true";
  const peg$c211 = peg$literalExpectation("true", false);
  const peg$c212 = function(): any { return spec.makeBooleanLiteral(true); };
  const peg$c213 = "false";
  const peg$c214 = peg$literalExpectation("false", false);
  const peg$c215 = function(): any { return spec.makeBooleanLiteral(false); };
  const peg$c216 = peg$otherExpectation("symbol");
  const peg$c217 = function(name: any, rest: any): any {
      return spec.makeNamespacedRef([name, ...rest.map((r:any) => r[1])]);
    };
  const peg$c218 = function(name: any): any {
      return spec.makeSymbolRef(name);
    };
  const peg$c219 = peg$otherExpectation("identifier");
  const peg$c220 = /^[a-z_]/i;
  const peg$c221 = peg$classExpectation([["a", "z"], "_"], false, true);
  const peg$c222 = /^[a-z0-9_]/i;
  const peg$c223 = peg$classExpectation([["a", "z"], ["0", "9"], "_"], false, true);
  const peg$c224 = function(prefix: any, suffix: any): any { return prefix+suffix.join(''); };
  const peg$c225 = /^[ \n\t\r]/;
